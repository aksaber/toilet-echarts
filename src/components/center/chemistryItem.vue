<template>
    <div id="chemistry-item">
        <div class="flex" style="align-items: center; margin-left: 20px">
            <span class="center-title">氨气/硫化氢今日曲线</span>
        </div>
        <div id="chemistryEcharts" style="width: 371px; height: 224px"></div>
    </div>
</template>
...
export default {
    name: 'ChemistryItem',
    mounted() {
        let myChart = echarts.init(document.getElementById('chemistryEcharts'));
        const option = {
            xAxis: {
                type: 'category',
